...
const links = [
  {text: 'Github', link: 'links/github', logo: 'social/github'},
  {text: 'Discord', link: 'links/discord', logo: 'social/discord'},
  {text: 'Telegram', link: 'links/telegram', logo: 'social/telegram'}
]
</script>
